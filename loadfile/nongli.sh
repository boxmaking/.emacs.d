...
lunar_nnian=$(echo $response | grep -o '"nnian":"[^"]*' | grep -o '[^"]*$')
...
lunar_ganzhinian=$(echo $response | grep -o '"ganzhinian":"[^"]*' | grep -o '[^"]*$')
lunar_ganzhiyue=$(echo $response | grep -o '"ganzhiyue":"[^"]*' | grep -o '[^"]*$')
lunar_ganzhiri=$(echo $response | grep -o '"ganzhiri":"[^"]*' | grep -o '[^"]*$')
lunar_yuexiang=$(echo $response | grep -o '"YUEXIANG":"[^"]*' | grep -o '[^"]*$')
lunar_jieqimsg=$(echo $response | grep -o '"jieqimsg":"[^"]*' | grep -o '[^"]*$')


echo "<$lunar_nnian-$lunar_nyue-$lunar_nri  $lunar_shengxiao> <$lunar_ganzhinian-$lunar_ganzhiyue-$lunar_ganzhiri> $lunar_yuexiang $lunar_jieqimsg "
